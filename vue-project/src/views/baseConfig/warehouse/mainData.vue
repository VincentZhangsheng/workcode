  ...
  <div class="table-page">
    <tool-bar @add-item="addItem">
      <template slot="tooltip">
        <pu-button @click="deleteItems" size="mini">
          <i class="el-icon-plus"></i>
          <span>add</span>
        </pu-button>
        <pu-button @click="deleteItems" size="mini" disabled>
...
export default {
  ...
  methods: {
    async getData() {
      let codeList = (await this.$http.post("/api/material/wh_info/query_wh_info_list", {
        pageNum: 1,
        pageSize: 10,
      })).data.list;
